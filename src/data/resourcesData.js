export const resourcesData = {
  downloadSection: {
    ...
    subtitle: "Explore our knowledge base by category.",
    steps: [
      { number: 1, label: "Select Resources" },
      { number: 2, label: "Fill Form Details" },
      { number: 3, label: "Download Documents" }
    ],
    resources: [
      {
        id: 1,
  ...
  newsletterSection: {
    ...
    subtitle: "Subscribe to our newsletter to get our news & updates delivered to you.",
    benefits: [
      { icon: "📊", text: "Latest research insights" },
      { icon: "🔄", text: "Product updates" },
      { icon: "👑", text: "Exclusive webinars" },
